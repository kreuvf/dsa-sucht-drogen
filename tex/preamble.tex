% preamble
\documentclass[ngerman,11pt,twoside,notitlepage]{report}
...
\DeclareSIUnit{\TaP}{TaP}
\DeclareSIUnit{\TaPstern}{TaP*}
...
\newcommand{\SIAP}[1]{\SI{#1}{\AP}} % AP
\newcommand{\SIGP}[1]{\SI{#1}{\GP}} % GP
\newcommand{\SILeP}[1]{\SI{#1}{\LeP}} % LeP
\newcommand{\SIAsP}[1]{\SI{#1}{\AsP}} % AsP
\newcommand{\SITaP}[1]{\SI{#1}{\TaP}} % TaP
\newcommand{\SITaPs}[1]{\SI{#1}{\TaPstern}} % TaP*
\newcommand{\SIZfP}[1]{\SI{#1}{\ZfP}} % ZfP
\newcommand{\SIZfPs}[1]{\SI{#1}{\ZfPstern}} % ZfP*
...
\setlist[enumerate]{topsep=3pt, partopsep=0pt, parsep=0pt, itemsep=3pt}
...
% % % % % % % % % % % % % % % % % % % %
% background
% Needs to be loaded after xcolor
\usepackage[pages=all]{background}
\backgroundsetup{
	scale = 1,
	angle = 0,
	opacity = 1,
	contents = {\includegraphics[width=\paperwidth, height=\paperheight]{res/matryoshka-437262.png}%
	}
}

% % % % % % % % % % % % % % % % % % % %
% multicol
% Nutzt Farbe, daher nach xcolor
\usepackage{multicol}
\setlength{\columnsep}{18pt}
\setlength{\columnseprule}{0.25ex}
\def\columnseprulecolor{\color{digibluedark}}
% Gehört zur Verhinderung eines Trennstriches bei _jedem_ \twocolumn (wie in der nomenclature)
\newcommand{\latexcolumnseprulecolor}{\color{red}}

% % % % % % % % % % % % % % % % % % % %
% etoolbox
% Verhindern, dass in jedem \twocolumn ein Trennstrich erscheint
% Selbst gepatcht aus:
% Quelle: https://tex.stackexchange.com/a/119111
% Quelle: https://tex.stackexchange.com/a/65542
\usepackage{etoolbox}
\makeatletter
...
% % % % % % % % % % % % % % % % % % % %
% biblatex
\usepackage[style=alphabetic,maxcitenames=2,maxbibnames=99999,hyperref=true,backref=true,abbreviate=false,alldates=iso,seconds=true,backend=biber]{biblatex}
...
\hypersetup{
	...
	pdftitle = {Sucht und Rauschmittel -- Inoffizielle Ersatzregeln zum Nachteil Sucht und Hausregeln zur Beschaffung, Herstellung und dem Konsum von Rauschmitteln inklusive Nebenwirkungen für Das Schwarze Auge 4.1},
