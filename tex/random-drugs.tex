...
\afterpage{
	...
	\begin{landscape}
		...
		\begin{tabularx}{\textheight}{@{\hspace{1pt}}C{1.7cm}@{\hspace{2pt}}C{1.1cm}@{\hspace{2pt}}L{5.9cm}C{1.3cm}L{10.7cm}C{0.35cm}@{\hspace{4pt}}C{0.35cm}@{\hspace{4pt}}C{0.35cm}@{\hspace{4pt}}C{0.35cm}@{\hspace{1pt}}}
...
Nach all den Regeln und langen Tabellen wird es Zeit, sich einige Beispiele anzuschauen, die verdeutlichen sollen wie diese Regeln angewendet werden sollen.
...
\subsubsection{Beschaffung in der Unterwelt (Erfolg)}
\begin{enumerate}
...
\subsubsection{Beschaffung in der Unterwelt (Fehlschlag, mit Konsequenzen)}
\begin{enumerate}
...
\subsubsection{Herstellung auf eigene Faust (Erfolg)}
\begin{enumerate}
...
\subsubsection{Herstellung auf eigene Faust (Fehlschlag, keine Ausgangsmaterialien)}
\begin{enumerate}
