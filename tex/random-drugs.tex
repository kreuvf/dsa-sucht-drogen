...
Mit dem passenden Wissen ausgestattet lassen sich Rauschmittel auch selbst herstellen. Die Gefahr dabei entdeckt zu werden, ist deutlich geringer als bei der Beschaffung in der Unterwelt. Dafür werden aber auch bis zu zwei Proben nötig: \emph{Kräutersuche}\footnote{Ich habe mich bewusst auf Pflanzen beschränkt. Als Anregung für Spieler und Meister sei aber erwähnt, dass neben pflanzlichen Inhaltsstoffen auch tierische oder mineralische vorstellbar sind, von Magie in Form von Humuselementaren oder einem \emph{Haselbusch und Ginsterkraut} ganz zu schweigen.} für die Beschaffung der Ausgangsstoffe und entweder \emph{Alchimie} oder \emph{Kochen} in einem wenigstens archaischen Labor. Die auf diesem Wege erzeugten Rauschmittel sind nur für den Eigenbedarf und definitiv nicht für den Handel gedacht.

\paragraph{Herstellung für Gruppenmitglieder}
Falls für andere Gruppenmitglieder Rauschmittel hergestellt werden sollen, so müssen diese dem Hersteller klarmachen, welcher Art der Rausch sein soll. Sofern der \emph{Pflanzenkunde}-TaW mindestens der Krankheitsstufe der Sucht entspricht, ist dies problemlos möglich. Darunter sind \emph{Pflanzenkunde}-Proben nötig, die um die Differenz aus \emph{Pflanzenkunde}-TaW und Krankheitsstufe der Sucht erschwert sind. Misslingt diese Probe, sind die Beschaffungs- und Herstellproben des Herstellers zusätzlich zur \emph{halben Krankheitsstufe der Sucht} um den Betrag der TaP* erschwert.
...
\begin{table}
	...
	\begin{tabular}{llccc}
		\toprule
		 &  & \raisebox{-0.5em}{Prüfwurf} & \multicolumn{2}{c}{Anzahl Nebenwirkungen} \\
		\arrayrulecolor{white}\cmidrule{3-3}\arrayrulecolor{digibluedark}
		\cmidrule(lr){4-5}
		\multirow{-2}*{\raisebox{0.35em}{Ergebnis}} & \multirow{-2}*{\raisebox{0.35em}{Hauptwirkung?}} & \raisebox{0.5em}{1W20 gegen ...} & {Gelungen} & {Misslungen} \\
		\hline
		Doppel-1 &  & {entfällt} & 0/0/0/0 & 0/0/0/0 \\
		\cmidrule{3-5}
		≥ 0 &  & ... Ergebnis & 0/0/0/0 & 1/0/0/0 \\
		\cmidrule{3-5}
		−1 bis −5 &  &  & 1/0/0/0 & 2/0/0/0 \\
		\arrayrulecolor{white}\cmidrule{4-5}\arrayrulecolor{digibluedark}
		−6 bis −10 &  & \multirow{-2}*{\raisebox{0.15em}{... 20 − |TaP*|}} & 2/0/0/0 & 3/0/0/0 \\
		\cmidrule{3-5}
		−11 bis −15 &  &  & 3/0/0/0 & 2/1/0/0 \\
		\arrayrulecolor{white}\cmidrule{4-5}\arrayrulecolor{digibluedark}
		−16 bis −20 & \multirow{-6}*{\raisebox{2em}{tritt ein}} &  & 2/1/0/0 & 1/2/0/0 \\
		\cmidrule{2-2}
		−21 bis −25 & tritt abgeschwächt ein &  & 1/2/0/0 & 1/1/1/0 \\
		\cmidrule{2-2}
		−26 bis −30 &  &  & 1/1/1/0 & 2/1/1/0 \\
		\arrayrulecolor{white}\cmidrule{4-5}\arrayrulecolor{digibluedark}
		< −30 &  & \multirow{-5}*{\raisebox{1.7em}{... 10}} & 2/1/1/0 & 1/1/1/1 \\
		\cmidrule{3-5}
		Doppel-20 & \multirow{-3}*{\raisebox{0.8em}{tritt nicht ein}} & ... 19 & 1/1/1/1 & 1/1/1/2 \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{p{3.25cm}p{6.75cm}p{5.7cm}}
		...
		mittelfristig & 1W3 Tage nach Ende der Hauptwirkung & 3~+~1W3 Tage \\
		langfristig & 1W3 Wochen nach Ende der Hauptwirkung & 3~+~1W3 Wochen \\
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item Nebenwirkungen: Probe mit 1W20 gegen 20 − |TaP*|, also 16
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Hauptwirkung tritt ein
		\item Nebenwirkungen: Probe mit 1W20 gegen 20 − |TaP*|, also 16
		\item 1W20 für Nebenwirkungsprobe: 17
	...
	\begin{itemize}
		...
		\item mittelfristig (nach 1W3~d, für 3~+~1W3~d): ab \SId{1} nach Ende der Hauptwirkung für \SId{4}
	\end{itemize}
