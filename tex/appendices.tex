...
\begin{tabularx}{\linewidth}{p{1.2cm}p{14.8cm}}
	...
	\hline \endfirsthead
	\caption[]{\cellcolor{white}\textit{Fortsetzung von der vorhergehenden Seite (Auswirkung 2 siehe S.~\pageref{tbl-auswirkungen}, 20 siehe S.~\pageref{conseq-bo}, 40 siehe S.~\pageref{conseq-do})}} \\
	\toprule
	{\cellcolor{white}Ergebnis} & {\cellcolor{white}Auswirkung} \\
	\hline
	\endhead
